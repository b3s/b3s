...
class RegistrationsController < ApplicationController
  ...
  def user_params
    params.expect(user: allowed_signup_params)
  end

  def allowed_signup_params
    [
      :username, :birthday, :description, :email, :pronouns,
      :latitude, :location, :longitude, :mobile_stylesheet_url,
      :mobile_theme, :notify_on_message, :realname,
      :stylesheet_url, :theme, :time_zone,
      :password, :password_confirmation, :hiatus_until,
      :preferred_format,
